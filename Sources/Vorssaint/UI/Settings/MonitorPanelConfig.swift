...
struct MonitorPanelConfig: View {
    ...
    private func itemTiles(for block: PanelConfigBlock) -> some View {
        ...
        case .usb:
            itemTile(l10n.s.usbShowTechDetails, symbol: "info.circle", value: $usbTechDetails, available: available)
            itemTile(l10n.s.usbShowEthernet, symbol: "network", value: $usbShowEthernet, available: available)
            itemTile(l10n.s.usbShowPowerCable, symbol: "bolt.fill", value: $usbShowPower, available: available)
        case .power:
...
private enum PanelConfigBlock: CaseIterable, Hashable {
    case system, network, disk, usb, power, mixer
