...
extension Strings {
    static let ptBR = Strings(
        ...
        videoDownloaderErrorNoVideo: "Este item não tem vídeo utilizável. Escolha MP3.",
...
extension Strings {
    static let enUS = Strings(
        ...
        videoDownloaderErrorNoVideo: "This item has no usable video stream. Choose MP3 instead.",
