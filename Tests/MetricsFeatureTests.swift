...
enum MetricsFeatureTests {
    static func run(_ suite: TestSuite) {
        ...
        suite.expect(bluetoothDevices.contains(PeripheralBatteryDevice(id: "Bluetooth:E5:04:BE:68:C2:93:left",
                                                                 name: "AirPods Pro (Left)",
                                                                 percent: 92,
                                                                 kind: .audio)),
               "peripheral battery includes individual AirPods Left component")
        suite.expect(bluetoothDevices.contains(PeripheralBatteryDevice(id: "Bluetooth:E5:04:BE:68:C2:93:right",
                                                                 name: "AirPods Pro (Right)",
                                                                 percent: 90,
                                                                 kind: .audio)),
               "peripheral battery includes individual AirPods Right component")
        suite.expect(bluetoothDevices.contains(PeripheralBatteryDevice(id: "Bluetooth:E5:04:BE:68:C2:93:case",
        ...
        suite.expect(airPodsMetric?.label == "AUD" && airPodsMetric?.value == "80%+1",
        ...
        suite.expect(airPodsPair?.left.percent == 80 && airPodsPair?.right.percent == 85,
               "airPodsProComponents identifies matching Left and Right components")
        suite.expect(PeripheralBatterySupport.isLeftEarbud(airPodsLeft),
               "isLeftEarbud detects left earbud")
        suite.expect(PeripheralBatterySupport.isRightEarbud(airPodsRight),
               "isRightEarbud detects right earbud")
        suite.expect(!PeripheralBatterySupport.isLeftEarbud(airPodsCase),
        ...
        suite.expect(PeripheralBatterySupport.airPodsProComponents(for: [airPodsMax]) == nil,
               "airPodsProComponents returns nil for AirPods Max")
        let maxMetric = PeripheralBatterySupport.menuBarMetric(for: [airPodsMax])
        suite.expect(maxMetric?.label == "AUD" && maxMetric?.value == "67%",
        ...
        suite.expect(audioAndMouseMetric?.label == "AUD" && audioAndMouseMetric?.value == "67%",
